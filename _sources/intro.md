...
**Introducción del Proyecto: Optimización del Diagnóstico de Gliomas mediante Ciencia de Datos y Aprendizaje Automático**
...
* **Fuente:** [text](https://archive.ics.uci.edu/dataset/759/glioma+grading+clinical+and+mutation+features+dataset)
